-- ---------------------------------------------------------------------
-- CEO yêu cầu 2026-08-06: thêm bảng so sánh Khách cá nhân/Khách công ty
-- (số khách hoạt động, số đơn, doanh thu, tỉ trọng đóng góp) cho Kế
-- toán/Giám đốc/Admin, đi kèm toggle thời gian — dùng ra quyết định/báo
-- cáo cổ đông, nhà đầu tư.
--
-- Tái dùng "period_defs" và "scoped" đã có sẵn (20260806160000) — chỉ
-- thêm 2 CTE mới để gộp theo (period, customer_type) rồi trả ra field
-- "periodByCustomerType": khoá theo tên kỳ, mỗi kỳ có 2 nhánh
-- individual/company, mỗi nhánh {customerCount, orderCount, revenue}.
-- ---------------------------------------------------------------------
...
-- So sánh Khách cá nhân/Khách công ty theo từng kỳ — join thẳng vào
-- customers để lấy customer_type, gộp theo (period, customer_type).

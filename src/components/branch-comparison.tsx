...
export function BranchComparisonSection({
  ...
  // — có thì hiện thêm khối Lợi nhuận gộp (doanh thu tháng − 2 khoản này).
  profit?: {
      ...
      {profitRows && (
        <Card>
          <CardHeader className="flex-row flex-wrap items-center justify-between gap-2">
            <div>
              {/* Tên ngắn gọn (CEO chốt) — tháng đang xem hiện ở ô chọn ngay cạnh. */}
              <CardTitle className="text-base">Lợi nhuận gộp</CardTitle>
              <p className="text-sm text-muted-foreground">
                Lãi = doanh thu (chưa VAT) − chi phí vận hành − quỹ lương tự tính từ Bảng lương.
              </p>
            </div>
            {/* Đổi tháng ở đây đổi luôn kỳ "tháng" của ô Doanh thu phía trên —

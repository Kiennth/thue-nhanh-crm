...
// Cần TOÀN BỘ đơn đã giao để tính thống kê/xu hướng theo thời gian — xu
...
//
// CEO chốt 2026-09-02: doanh số ghi nhận khi ĐÃ GIAO HÀNG (delivered_at,
// thay quy tắc đơn-hoàn-tất 2026-08-08) và GỒM VAT — khớp "Tổng doanh số"
...
export async function computeOrdersOverview(
  ...
  const orders = await fetchDeliveredOrders(branchId);
